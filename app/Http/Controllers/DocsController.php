 ...
 * @link https://github.com/laravel/laravel.com-next/blob/master/app/Http/Controllers/DocsController.php
 */
class DocsController extends Controller
{
    ...
    public function show($version, $page = null)
    {
        ...
        if (is_null($content)) {
            ...
            return response()->view('AldrumoCom::docs.docs', [
                'title' => 'Page not found',
                'index' => $this->docs->getIndex($version),
                'content' => view('AldrumoCom::docs.docs-missing', [
        ...
        return view('AldrumoCom::docs.docs', [
